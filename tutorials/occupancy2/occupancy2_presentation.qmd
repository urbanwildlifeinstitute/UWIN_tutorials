...
- Can include covariates that vary spatial, temporal, and spatiotemporal covariates.
...
- Furthermore, temporal or spatiotemporal covariates can vary among secondary sampling periods within a primary sampling period (e.g., daily average rainfall).
:::
...
Occupancy estimates:
          ...
          parameter    Est    SE  lower  upper
1 psi - (Intercept) -0.533 0.156 -0.758 -0.308
2      psi - forest  1.167 0.153  0.947  1.387
3       psi - theta  1.006 0.274  0.611  1.401
...
Detection estimates:
          ...
          parameter   Est    SE lower upper
4 rho - (Intercept) 0.335 0.107 0.180 0.489
5      rho - forest 0.642 0.113 0.479 0.805
