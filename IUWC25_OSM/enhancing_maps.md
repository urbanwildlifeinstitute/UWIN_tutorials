...
```
<p float="center">
  <img src="./figures/ESA_map_Argentina.png" alt="Plot of European Space Agency (ESA) landcover data for Argentina cropped to study region" width="800" height="auto" />
